...
// Fazendo a conexão com o servidor MySQL 
    ...
    <br><br><center><table border="1" cellspacing=0 cellpadding=3 bordercolor="000203"><tr> 
...
<FORM action='gera_grafico.php' method='POST' id='form'>  </br></br>
    <div class='row'>
        <div class='col-sm-12'>
            <div class='text-center'><input type='submit' name='financiar' class='btn btn-primary btn-lg' value='Ver Gráfico'>
            <INPUT class="btn btn-theme" TYPE="BUTTON" VALUE="SAIR" ONCLICK="window.location.href = 'home_adm.php'"></div></div></div>
            </FORM>

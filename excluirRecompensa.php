...
<div class="col-md-9 well admin-content" id="home">
    <form action="excluiRecompensa.php" method="POST" id="form" name="frm">
        <div class="text-center">
            <h2><ins>Exclusão de Recompensas </ins></h2><br></div>
       
            <br> <b> (*) campos de preenchimento obrigatório </b><br><br><br>
            
        <b> *Nome do Projeto: </b> <input type="text" name="nome" size="50" required><br><br>
        <b> *Recompensa: </b> <input type="text" name="recompensa" size="50" required><br><br> <br>
        <div class="row">
            <div class="col-sm-12">
                <div class="text-center">						
